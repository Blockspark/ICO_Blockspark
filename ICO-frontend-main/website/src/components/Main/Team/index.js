const Team = () => {
    return (
        <>
                     <section className="section our-team our-team-bg" id="ourteam">
          <div className="container">
              <div className="our-team-wrp">
              <h2 className="section-title text-center text-capitalize">Our <span className="section-title-efct">Team</span> </h2>
              
           <div className="row our-team-row text-center">
