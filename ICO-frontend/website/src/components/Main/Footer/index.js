         ...
         <div className="container">
           <div className="footer-sec-wrp">
             <div className="footer-sec-top text-center text-capitalize">
               <img src={ require("../../../assets/images/new_Metaflix_footer_logo.png") }  alt=""/>
               {/* <h4 className="footer-top-title mt-2">MetaFlixWorld</h4> */}
             ...
             <div className="footer-sec-bottom">
               ...
               <span className="footer-text-left">© 2022 MetaFlixWorld. All rights reserved</span>
               <span className="footer-right"> <ul className="list-group list-group-horizontal justify-content-end">
                <li className="list-group-item social-links-right"><a href="https://www.instagram.com/MetaflixWorld" className="social-links"><i className="fa-brands fa-instagram"></i></a></li>
                <li className="list-group-item social-links-right"><a href="https://discord.gg/kHhr7NaE" className="social-links"><i className="fa-brands fa-discord"></i></a></li>
                <li className="list-group-item social-links-right"><a href="https://twitter.com/MetaflixWorld" className="social-links"><i className="fa-brands fa-twitter"></i></a></li>
                <li className="list-group-item social-links-right"><a href="https://www.youtube.com/@MCubeBiz" className="social-links"><i className="fa-brands fa-youtube"></i></a></li>
                <li className="list-group-item social-links-right"><a href="mailto:info@metaflixworld.io" className="social-links"><i className="fa-brands fa-solid fa-envelope"></i></a></li>
                          ...
                          <div id="accordion">
                            <div className="card mt-1 card-faq" >
                              <div className="card-header">
                                <a className="btn" data-bs-toggle="collapse" href="#collapseOne">
                                  How do I create an account on MetaFixWorld?
                                </a>
                              </div>
                                ...
                                <div className="card-body">
                                  <div className="row">
                                          <div className="col-12">
                                              <p>You can register yourself on the MetaFixWrold website.</p> 
                                              <p>Enter your Full name, Email ID, and Password, and get yourself Signed up.</p>
                                          </div>
                                          <div className="col-12">
                                            <iframe width="900" height="500" src="https://www.youtube.com/embed/FUEuoG2OuJ0?si=WEplBDbZ7jiTX4CZ" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                                          </div>
                                    </div>
                                </div>
                              </div>
                            ...
                            <div className="card mt-1 card-faq">
                              <div className="card-header">
                                ...
                                How do I complete the KYC process for an MetaFix token purchase?
                                ...
                                <div className="card-body">
                                  <div className="row">
                                          <div className="col-12">
                                              ...
                                              <p>3. Setup Account and connect account with MetaFixapp</p>
                                          </div>
                                          <div className="col-12">
                            ...
                            <div className="card mt-1 card-faq">
                              ...
                              <div id="collapseThree" className="collapse" data-bs-parent="#accordion">
                                <div className="card-body">
                                  ...
                                  <div className="row">
                                          <div className="col-12">
                                              <p>You can buy MetaFix tokens with ETH, USDT DAI token.</p> 
                                          </div>
                                          <div className="col-12">
                            ...
                            <div className="card mt-1 card-faq">
                              ...
                              <div id="collapsefaq" className="collapse" data-bs-parent="#accordion">
                                <div className="card-body">                                  
                                  <p><a href="http://metaflixworld.info/">FAQ</a></p>
                                </div>
                              </div>
                            </div>
                          </div>
